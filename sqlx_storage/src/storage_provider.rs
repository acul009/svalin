...
impl<C: Codec> StorageProvider<CURRENT_VERSION> for SqliteStorageProvider<C> {
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::JoinGroupConfig);
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::Tree);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            storable.store::<_, C>(&self.pool, group_id, GroupDataType::InterimTranscriptHash);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::Context);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::ConfirmationTag);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::GroupState);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::MessageSecrets);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::ResumptionPskStore);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::OwnLeafIndex);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, group_id, GroupDataType::GroupEpochSecrets);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, public_key);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, _, C>(&self.pool, group_id, epoch, leaf_index);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, hash_ref);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.store::<_, C>(&self.pool, psk_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::JoinGroupConfig);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableLeafNode::load::<_, C>(&self.pool, group_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableProposal::<u8, ProposalRef>::load_refs::<_, C>(&self.pool, group_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableProposal::load::<_, C>(&self.pool, group_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::Tree);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::Context);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::ConfirmationTag);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::GroupState);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::MessageSecrets);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::OwnLeafIndex);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task =
            StorableGroupData::load::<_, C>(&self.pool, group_id, GroupDataType::GroupEpochSecrets);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableSignatureKeyPairs::load::<_, C>(&self.pool, public_key);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableEncryptionKeyPair::load::<_, C>(&self.pool, public_key);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = load_epoch_key_pairs::<_, _, _, C>(&self.pool, group_id, epoch, leaf_index);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = StorableKeyPackage::load::<_, C>(&self.pool, hash_ref);
        block_async_in_place(task)
    }
    ...
    fn psk<PskBundle: traits::PskBundle<CURRENT_VERSION>, PskId: traits::PskId<CURRENT_VERSION>>(
        ...
        let task = load_psk_bundle::<_, _, C>(&self.pool, psk_id);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.delete_proposal(&self.pool, proposal_ref);
        block_async_in_place(task)
    }
    ...
    fn delete_own_leaf_nodes<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_leaf_nodes(&self.pool);
        block_async_in_place(task)
    }
    ...
    fn delete_group_config<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::JoinGroupConfig);
        block_async_in_place(task)
    }
    ...
    fn delete_tree<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::Tree);
        block_async_in_place(task)
    }
    ...
    fn delete_confirmation_tag<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::ConfirmationTag);
        block_async_in_place(task)
    }
    ...
    fn delete_group_state<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::GroupState);
        block_async_in_place(task)
    }
    ...
    fn delete_context<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::Context);
        block_async_in_place(task)
    }
    ...
    fn delete_interim_transcript_hash<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::InterimTranscriptHash);
        block_async_in_place(task)
    }
    ...
    fn delete_message_secrets<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::MessageSecrets);
        block_async_in_place(task)
    }
    ...
    fn delete_all_resumption_psk_secrets<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::ResumptionPskStore);
        block_async_in_place(task)
    }
    ...
    fn delete_own_leaf_index<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::OwnLeafIndex);
        block_async_in_place(task)
    }
    ...
    fn delete_group_epoch_secrets<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let task = storable.delete_group_data(&self.pool, GroupDataType::GroupEpochSecrets);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.delete_all_proposals(&self.pool);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.delete::<C>(&self.pool);
        block_async_in_place(task)
    }
    ...
    >(
        ...
        let task = storable.delete_epoch_key_pair(&self.pool, epoch, leaf_index);
        block_async_in_place(task)
    }
    ...
    fn delete_key_package<KeyPackageRef: traits::HashReference<CURRENT_VERSION>>(
        ...
        let task = storable.delete_key_package::<C>(&self.pool);
        block_async_in_place(task)
    }

...
use cosmic::iced::advanced::{self, Clipboard, Layout, Shell, Widget};
use cosmic::iced::event;
use cosmic::iced::mouse;
use cosmic::iced::time::Instant;
use cosmic::iced::widget::canvas;
use cosmic::iced::window::{self, RedrawRequest};
use cosmic::iced::{Background, Color, Event, Radians, Rectangle, Renderer, Size, Vector};
...
impl StyleSheet for cosmic::Theme {
    ...
    fn appearance(&self, _style: &Self::Style) -> Appearance {
        Appearance {
            background: None,
            track_color: self.cosmic().primary_component_color().into(),
            bar_color: self.cosmic().primary_container_color().into(),
        }
    }
}

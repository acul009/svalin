...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -134119255;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        5 => wire_first_connect_impl(port, ptr, rust_vec_len, data_len),
        3 => wire_init_app_impl(port, ptr, rust_vec_len, data_len),
        4 => wire_list_profiles_impl(port, ptr, rust_vec_len, data_len),
        2 => wire_stream_time_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}

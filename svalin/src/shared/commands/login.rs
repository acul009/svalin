...
impl TakeableCommandHandler for LoginHandler {
    ...
    async fn handle(
        ...
        if let Some(mut session) = session.take() {
            ...
            // tracing::trace!("reading for client nonce");
            ...
            // tracing::trace!("reading for strong username");
            ...
            // tracing::trace!("hash params: {}", &client_info.hash_params);
...
impl TakeableCommandDispatcher for Login {
    ...
    async fn dispatch(
        ...
        if let Some(mut session) = session.take() {
            ...
            // tracing::trace!("tls transport created");
            ...
            // tracing::trace!("receiving server nonce");
            ...
            // tracing::trace!("starting augmentation task");
            ...
            // tracing::trace!("sending strong username");
            ...
            // tracing::trace!("receiving client info");
            ...
            // tracing::trace!("sending client public key");
            ...
            // tracing::trace!("receiving server public key");
            ...
            // tracing::trace!("sending client authenticator");
            ...
            // tracing::trace!("receiving server authenticator");
